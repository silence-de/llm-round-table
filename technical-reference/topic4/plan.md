...
- [ ] `high` 级别：阻断该来源进入 evidenceRefs，记录到 `suspicious_content_log` 表
- [ ] `medium` 级别：允许进��但在 claim 上标注 `injectionRisk: true`
